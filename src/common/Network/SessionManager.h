...
public:
    ...
    [[nodiscard]] utils::async<std::size_t> Count() const;
    ...
    using AsyncSessionHandler = std::function<utils::async<void>(TcpSession::Ptr)>;
    utils::async<void> ForEachAsync(const AsyncSessionHandler& fn) const;
